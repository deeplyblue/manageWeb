...
<head>
    <title>Title</title>
    <script src="${ctx}/js/views/system/roleInfoApp.js"></script>
</head>
    ...
    <div>
        ...
        <table table-detail>
            ...
            <shiro:hasPermission name="sys-role_toRolesResources">
                <td><button ng-click="vm.resourceAllocate(bean.roleId)">权限分配</button>
            </shiro:hasPermission>
                <button ng-click="vm.jobAllocate(bean.roleId)">岗位职责分配</button></td>
            </tbody>
            <tfoot>
            <tr>
            </tr>
