...
<head>
    <title>Title</title>
    <script src="${ctx}/js/views/reserve/reserveBalanceApp.js"></script>
</head>
<body ng-app="myApp" style="overflow:scroll;overflow-x:hidden">

<core:import url="../common/pageHead.jsp">
    <core:param name="title" value="查询备付金当日发生额信息 "/>
</core:import>
    ...
    <div>
        ...
        <table table-detail>
            ...
            <tr>
                ...
                <td>{{bean.currentBusinessRec}}</td>
                <td>{{bean.currentBusiPaidRec}}</td>
                <td>{{bean.currentBusinessPay}}</td>
                <td>{{bean.currentBusiPaidPay}}</td>
                <td>{{bean.businessAddBankNoAdd}}</td>
                <td>{{bean.businessSubBankNoSub}}</td>
            </tr>
            </tbody>
