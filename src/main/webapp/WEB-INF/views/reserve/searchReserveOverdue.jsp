...
<head>
    <title>Title</title>
    <script src="${ctx}/js/views/reserve/reserveOverdueApp.js"></script>
</head>
<body ng-app="myApp" style="overflow:scroll;overflow-x:hidden">

<core:import url="../common/pageHead.jsp">
    <core:param name="title" value="逾期未核对数据信息查询 "/>
</core:import>

<div ng-controller="queryCtrl" class="container-fluid">
    <form id="queryForm" name="queryForm" action="${ctx}/reserve/data/overdue/overdueSearch" class="form-inline" autocomplete="off">
        <table table-detail>
            <tr>
                <td class="text-right">
                    报文工作日期：
    ...
    <div>
        ...
        <table table-detail>
            ...
            <tr>
                ...
                <td>{{bean.batchNo}}</td>
                <td>{{bean.messageDate | date:'yyyy-MM-dd'}}</td>
                <td>{{{'01':'未处理','02':'已处理'}[bean.isRemark]}}</td>
                <td><button  ng-click="vm.queryOverdueDetail(bean)">查看</button></td>
            </tr>
            </tbody>
