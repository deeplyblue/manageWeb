...
<div common-modal-form>
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="branchNO" ng-model="vm.item.branchNO" class="{{vm.constant.inputClass}} "  />
                </td>
                <td class="text-right">
                    分公司名称：
                </td>
                <td>
                    <input type="text" name="branchName" ng-model="vm.item.branchName" class="{{vm.constant.inputClass}} "  />
                </td>
            </tr>
            <tr>
                <td class="text-right">
