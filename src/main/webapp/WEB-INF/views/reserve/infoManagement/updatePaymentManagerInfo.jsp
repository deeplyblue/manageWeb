...
<div common-modal-form>
        <table class="table table-bordered">
            <tr>
                ...
                <td>
                    <input type="text" name="orgName" ng-model="vm.item.orgName" class="{{vm.constant.inputClass}} " readonly="readonly" required  maxlength="90"/>
                </td>
            </tr>
            <tr>
                <td class="text-right">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="idCard" ng-model="vm.item.idCard" class="{{vm.constant.inputClass}} " required  ng-pattern="/(^[1-9]\d{5}(18|19|([23]\d))\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$)|(^[1-9]\d{5}\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{2}$)/" style="ime-mode:disabled" maxlength="100"/>
                </td>
                <td class="text-right">
                    离职标识：
                </td>
