...
<div style="border: dashed grey 1px;padding:2px 0px 5px 0px;margin-left: inherit;margin-right: 5px;
    ...
    <table border="1" style="width: 1300px;text-align: center;word-wrap:break-word;word-break:break-all;">
        ...
        <tr>
            ...
            <td rowspan="2">客户资金账户期初余额</td>
            <td rowspan="2">本期入金业务贷记客户资金账户金额</td>
            <td rowspan="2">本期出金业务借记客户资金账户金额</td>
            <td colspan="2">本期内部客户资金账户转账业务</td>
            <td rowspan="2">客户资金账户期末余额</td>
        </tr>
        <tr>
            <td>客户资金账户借方发生额</td>
            <td>客户资金账户贷方发生额</td>
        ...
        <tr ng-repeat="bean in vm.item.list track by $index">
            <%--<td><input name="check" type="checkbox" ng-model="bean._checked"></td>--%>
                ...
                <td>{{bean.e01/1000000}}</td>
                <td>{{bean.e02/1000000}}</td>
                <td>{{bean.e03/1000000}}</td>
                <td>{{bean.e04/1000000}}</td>
                <td>{{bean.e05/1000000}}</td>
                <td>{{bean.e06/1000000}}</td>
        </tr>
    </table>
