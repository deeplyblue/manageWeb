...
<div style="border: dashed grey 1px;padding:2px 0px 5px 0px;margin-left: inherit;margin-right: 5px;
    ...
    <table border="1" style="width: 1400px;text-align: center;word-wrap:break-word;word-break:break-all;">
        <thead>
        <tr>
            <td width="190px">账号</td>
            <td width="80px">交易日期</td>
            <td>支付机构业务系统已增加客户资金账户余额，备付金银行未增加备付金银行账户余额</td>
            <td>支付机构业务系统已减少客户资金账户余额，备付金银行未减少备付金银行账户余额</td>
            <td>备付金银行已增加备付金银行账户余额，支付机构业务系统未增加客户资金账户余额</td>
            <td>备付金银行已减少备付金银行账户余额，支付机构业务系统未减少客户资金账户余额</td>
        </tr>
        </thead>
        <tr ng-repeat="bean in vm.item.list track by $index">
            <%--<td><input name="check" type="checkbox" ng-model="bean._checked"></td>--%>
                ...
                <td>{{bean.j01/1000000}}</td>
                <td>{{bean.j02/1000000}}</td>
                <td>{{bean.j03/1000000}}</td>
                <td>{{bean.j04/1000000}}</td>
        </tr>
    </table>
