    ...
    <form autocomplete="off">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td class="col-xs-4">
                    <input type="text" placeholder="多个机构用'|'拼接" ng-model="vm.item.transMerchantCode" class="{{vm.constant.inputClass}} ">
                </td>
            </tr>
            <tr>
                <td class="text-right">
            ...
            <tr>
                ...
                <td>
                    ...
                    <select  ng-model="vm.item.currency" class="{{vm.constant.inputClass}}"
            ...
            <tr>
                ...
                <td>
                    ...
                    <select ng-model="vm.item.certType" class="{{vm.constant.inputClass}}"
            ...
            <tr>
                ...
                <td>
                    ...
                    <select  ng-model="vm.item.accountNature" class="{{vm.constant.inputClass}}"
