...
<div common-modal-form>
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td class="col-xs-4">
                    <input type="text" ng-model="vm.item.templateName" class="{{vm.constant.inputClass}}"
            ...
            <tr>
                ...
                <td>
                    <select ng-model="vm.item.feeMethod" class="{{vm.constant.inputClass}}" required name="feeMethod"
            ...
            <tr>
                ...
                <td>
                    <select ng-model="vm.item.feeUnit" class="{{vm.constant.inputClass}}" required name="feeUnit"
            ...
            <tr>
                ...
                <td>
                    <select ng-model="vm.item.feeSegType" class="{{vm.constant.inputClass}}"  required name="feeSegType"
                            ng-options="key as value for (key,value) in {'01':'阶梯','02':'累进'}">
                        <option value="">请选择</option>
                    </select>
                </td>
            </tr>
            ...
            <tr ng-repeat="temp in vm.item.feeSegRateModelList track by $index ">
                ...
                <td>
                    <input ng-if="vm.item.feeSegRateModelList[$index].feeSegMethod == '02'" type="text"
                           ...
                           ng-model="vm.item.feeSegRateModelList[$index].feeUppLmt"class="{{vm.constant.inputClass}}">
                </td>
            </tr>
        </table>
