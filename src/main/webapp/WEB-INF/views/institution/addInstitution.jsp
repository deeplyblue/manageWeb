...
<div common-modal-form>
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td class="col-xs-4">
                    <input type="text" ng-model="vm.item.orgCode" class="{{vm.constant.inputClass}} "
                           w5c-unique-check="{url:'${ctx}/institution/payment/checkOrgCode?orgCode='+vm.item.orgCode}"
                           required name="orgCode">
                </td>
            </tr>
            <tr>
                <td class="text-right">
            ...
            <tr>
                ...
                <td>
                    <select ng-model="vm.item.channelType" class="{{vm.constant.inputClass}}" required name="channelType"
            ...
            <tr>
                ...
                <td>
                    <input type="text" ng-model="vm.item.orgName" class="{{vm.constant.inputClass}} "
                           w5c-unique-check="{url:'${ctx}/institution/payment/checkName?orgName='+vm.item.orgName}"
            ...
            <tr>
                ...
                <td>
                    <input type="text" ng-model="vm.item.orgAbbrName" class="{{vm.constant.inputClass}} "
                           w5c-unique-check="{url:'${ctx}/institution/payment/checkAbbrName?orgAbbrName='+vm.item.orgAbbrName}"
            ...
            <tr>
                ...
                <td>
                    省:<select ng-model="vm.pro" ng-options="item as item.areaName for item  in vm.cached.ALL_CITY" class="{{vm.constant.inputClass}} "
                              ng-init="vm.item.orgArea = vm.pro.areaCode + '' + vm.city.cityCode"  required name="areaName">

                </select>
                    <div ng-if="vm.pro" >
                        市:<select ng-model="vm.city" ng-options="item as item.cityName for item in vm.pro.citys" class="{{vm.constant.inputClass}} "
                                  ng-change="vm.item.orgArea = vm.pro.areaCode + '' + vm.city.cityCode" name="cityName" required>
                    </select>
                    </div>
            ...
            <tr>
                ...
                <td>
                    <input type="text" ng-model="vm.item.payOrgLevel" name="payLevel" ng-maxlength="2"  class="{{vm.constant.inputClass}} ">
                </td>
            </tr>
            <%--<tr>--%>
                <%--<td class="text-right">--%>
