...
<body>
<div>
    <form name="addPayOrgChkCfg" novalidate w5c-form-validate class="form-inline" autocomplete="off">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td class="col-xs-4">
                    <select type="text" ng-model="vm.item.chkType" ng-init="vm.item.chkType='02'"
            ...
            <tr>
                ...
                <td class="col-xs-4">
                    <select type="text" ng-model="vm.item.refundCheckFlag" ng-init="vm.item.refundCheckFlag='1'"
                            class="{{vm.constant.inputClass}} ">
