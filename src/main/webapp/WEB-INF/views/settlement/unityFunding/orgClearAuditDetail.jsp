...
<body>
<div>
<shiro:hasPermission name="orgClearDetail_auditSuccese">
    <button ng-click="vm.audit(vm.item.list[0].handleBatchNo,'02')" ng-if="vm.item.list[0].auditStatus == '01'">审核成功
    </button>
</shiro:hasPermission>
<shiro:hasPermission name="orgClearDetail_auditFail">
    <button ng-click="vm.auditFail(vm.item.list[0].handleBatchNo,vm.item.list[0].clrDate,vm.item.list[0].clrType)" ng-if="vm.item.list[0].auditStatus == '01'">审核失败</button>
</shiro:hasPermission>
    <table table-detail>
        <thead>
        <tr>
