...
<head>
    <title>Title</title>
    <script src="${ctx}/js/views/settlement/report/formsReport/payOrgCodePaymentApp.js"></script>
</head>
<body ng-app="myApp" style="overflow:scroll;overflow-x:hidden">
<core:import url="../../../common/pageHead.jsp">
    <core:param name="title" value="支付业务手续费支出结算明细表"/>
</core:import>
<div ng-controller="queryCtrl" class="container-fluid">
    <form id="queryForm" name="queryForm" action="${ctx}/settlement/report/formsReport/payOrgCodePaymentFeeCfg/search"
        ...
        <table class="table table-bordered table-condensed">
            ...
            <tr align="center">
                <td colspan="6">
                    ...
                    <button down-file="${ctx}/settlement/report/formsReport/payOrgCodePaymentFeeCfg/download" params="vm.queryBean"
    ...
    <div>
        ...
        <div>
            <st-table-data st-data="vm.pagination.list" st-caches="vm.cached">
                ...
                <st-table-column st-head="支付机构" st-field="payOrgCode" st-mapping="COMANY_CODE" />
                <st-table-column st-head="业务种类" st-field="busiType" />

                <st-table-column st-head="业务笔数" st-field="countMonth"/>
                <st-table-column st-head="结算金额" st-field="amtMonth" st-field-type="currency"/>
                <st-table-column st-head="计费费率" st-field="mchntCode" />
