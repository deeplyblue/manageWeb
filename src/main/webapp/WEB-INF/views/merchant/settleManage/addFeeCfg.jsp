            ...
            <tr>
                ...
                <td>
                    <input type="text" ng-model="vm.item.companyCode" class="{{vm.constant.inputClass}}" required name="companyCode"
                           typeahead-min-length="0"   uib-typeahead="item.key as item.value for item in vm.cached.MERCHANT_CODE | filter:$viewValue | limitTo:10" required name="companyCode">
                </td>
            </tr>
            <input type="text" ng-model="vm.item.companyType" ng-init="vm.item.companyType = '<%=CompanyType.MERCHANT.getCode()%>'" ng-show="false" />
            <tr>
                <td class="text-right">
                    配置模式：
                </td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="{{vm.constant.inputClass}}"  uib-datepicker-popup="yyyy-MM-dd"
                           name="validateBeginDate"
                           ng-model="vm.item.validateBeginDate" required />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="{{vm.constant.inputClass}}"  uib-datepicker-popup="yyyy-MM-dd"
                           ...
                           ng-model="vm.item.validateEndDate" required />
                </td>
            </tr>
