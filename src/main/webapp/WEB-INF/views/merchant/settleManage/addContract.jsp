...
<div common-modal-form>
    ...
    <table class="table table-bordered">
        <tr>
            ...
            <td class="col-xs-4">
                <input type="text" ng-model="vm.item.companyCode" class="{{vm.constant.inputClass}}"
                       uib-typeahead="item.key as item.value for item in vm.cached.MERCHANT_CODE | filter:$viewValue | limitTo:10" required name="companyCode">
            </td>
        </tr>
        <tr>
            <td class="text-right">
            ...
            <td>
                <input type="text" ng-model="vm.item.contCode" class="{{vm.constant.inputClass}}"
                       w5c-unique-check="{url:'${ctx}/merchant/merchantContaract/check?companyCode='+vm.item.companyCode+'&contCode='+vm.item.contCode}"
                       required name="contCode">
            </td>
        </tr>
        <tr>
            <td class="text-right">
        ...
        <tr>
            ...
            <td>
                <%--<input type="file" ng-model="vm.item.dfsOpenBankCert"class="{{vm.constant.inputClass}}" />--%>
        ...
        <tr>
            ...
            <td>
                <%--<input type="file" ng-model="vm.item.dfsRatePayerCert"class="{{vm.constant.inputClass}}" />--%>
        ...
        <tr>
            ...
            <td>
                <%--<input type="file" ng-model="vm.item.dfsTaxRegisterCert"class="{{vm.constant.inputClass}}" />--%>
        ...
        <tr>
            ...
            <td>
                <%--<input type="file" ng-model="vm.item.dfsBizLicenseCert"class="{{vm.constant.inputClass}}" />--%>
        ...
        <tr>
            ...
            <td>
                ...
                <%--<input type="file" ng-model="vm.item.dfsOrganizationCodeCert"class="{{vm.constant.inputClass}}" />--%>
            </td>
        </tr>
        <tr>
            <td class="text-right">
            ...
            <td>
                ...
                <%--<input type="file" ng-model="vm.item.dfsBankFile"class="{{vm.constant.inputClass}}" />--%>
            </td>
        </tr>
        <tr>
