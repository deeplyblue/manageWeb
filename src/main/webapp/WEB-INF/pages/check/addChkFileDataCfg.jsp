...
<div common-modal-form>
        ...
        <table class="table table-bordered">
            <tr>
                ...
                <td class="col-xs-4">
                    <input type="text" ng-model="vm.item.templateNo" class="{{vm.constant.inputClass}} " required name="templateNo" >
                </td>
            </tr>
            <tr>
                <td class="text-right col-xs-3">对账文件模板名称</td>
                <td class="col-xs-4">
                    <input type="text" ng-model="vm.item.templateName" class="{{vm.constant.inputClass}} " required name="templateName">
                </td>
            </tr>
        </table>
        <table class="table table-bordered">
            ...
            <tr ng-repeat="bean in vm.chkFileDataField track by $index">
                <td>
