...
<div common-modal-form>
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td class="col-xs-4">
                    <select type="text" ng-model="vm.item.fileMethod" class="{{vm.constant.inputClass}} " required name="fileMethod">
                        <%
            ...
            <tr ng-if="vm.item.fileMethod == 01 || vm.item.fileMethod == 02">
                ...
                <td class="col-xs-4"><input type="text" ng-model="vm.item.ftpHost" class="{{vm.constant.inputClass}} " required name="ftpHost" w5c-dynamic-element></td>
            </tr>
            <tr ng-if="vm.item.fileMethod == 01 || vm.item.fileMethod == 02">
                <td class="text-right col-xs-3">FTP端口</td>
                <td class="col-xs-4"><input type="text" ng-model="vm.item.ftpPort" class="{{vm.constant.inputClass}} "  required name="ftpPort" w5c-dynamic-element></td>
            </tr>
            <tr ng-if="vm.item.fileMethod == 01 || vm.item.fileMethod == 02">
                <td class="text-right col-xs-3">FTP用户名</td>
                <td class="col-xs-4"><input type="text" ng-model="vm.item.ftpUser" class="{{vm.constant.inputClass}} " required name="ftpUser" w5c-dynamic-element></td>
            </tr>
            <tr ng-if="vm.item.fileMethod == 01 || vm.item.fileMethod == 02">
                <td class="text-right col-xs-3">FTP密码</td>
                <td class="col-xs-4"><input type="text" ng-model="vm.item.ftpPwd" class="{{vm.constant.inputClass}} " required name="ftpPwd" w5c-dynamic-element></td>
            </tr>
            <tr ng-if="vm.item.fileMethod == 01 || vm.item.fileMethod == 02">
                <td class="text-right col-xs-3">FTP远程目录</td>
                <td class="col-xs-4"><input type="text" ng-model="vm.item.ftpRemoteDir" class="{{vm.constant.inputClass}} "required name="ftpRemoteDir" w5c-dynamic-element>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="col-xs-4">
                    <select type="text" ng-model="vm.item.dependOnBankChkFlag" class="{{vm.constant.inputClass}} ">
                        <%
