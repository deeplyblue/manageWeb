...
<head>
    <title>Title</title>
    <script src="${ctx}/build/js/views/check/bankChkResultApp-38427e208b.js"></script>
    <link rel="stylesheet" href="${ctx}/css/common.css">
</head>
<body ng-app="myApp" style="overflow:scroll;overflow-x:hidden">
<core:import url="../common/pageHead.jsp">
    <core:param name="title" value="银行对账结果查询"/>
</core:import>
<div ng-controller="queryCtrl" class="container-fluid">
    <form id="queryForm" name="queryForm" action="${ctx}/check/bankChkResult/search" autocomplete="off">
...
<shiro:hasPermission name="bankChkResult_download">
                    <button down-file="${ctx}/check/bankChkResult/download"
    ...
    <div>
        <table table-detail>
            ...
            <tr>
                ...
                <td>{{(bean.transAmtD/100)-(bean.transAmtC/100)| currency:""}}</td>
