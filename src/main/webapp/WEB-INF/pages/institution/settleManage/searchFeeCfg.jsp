...
<head>
    <title>Title</title>
    <script src="${ctx}/build/js/views/institution/settleManage/feeCfgInfoApp-cde98f130e.js"></script>
</head>


<body ng-app="myApp" style="overflow:scroll;overflow-x:hidden">
<core:import url="../../common/pageHead.jsp">
    <core:param name="title" value="查询支付机构手续费 "/>
</core:import>
<div ng-controller="queryCtrl" class="container-fluid">
    <form id="queryForm" name="queryForm" action="${ctx}/merchant/feeCfg/search" autocomplete="off">
        <table table-form>
            ...
            <input type="text" ng-model="vm.queryBean.companyType"
                   ng-init="vm.queryBean.companyType = '<%=CompanyType.PAY.getCode()%>'" ng-show="false"/>
            <tr align="center">
                <td colspan="6">
    ...
    <div>
        <shiro:hasPermission name="org-feeCfg_add">
            <button ng-click="vm.addItem()"><i class="glyphicon glyphicon-plus"></i></button>
        </shiro:hasPermission>
        <shiro:hasPermission name="org-feeCfg_update">
        ...
        <table table-detail>
            ...
            <tr>
                ...
                <td> <shiro:hasPermission name="org-feeCfg_open">
                    <button type="button" ng-if="bean.enableFlag=='0'"
                            ng-click="vm.updateItemEnableFlag(bean,'1')">
                        启用
                    </button>
                </shiro:hasPermission>
                    <shiro:hasPermission name="org-feeCfg_close">
                        <button type="button" ng-if="bean.enableFlag=='1'"
