    ...
    <form>
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td class="col-xs-4">
                    <%--<input type="text" ng-model="vm.item.cdFlag" class="form-control input-sm">--%>
                    <select ng-model="vm.item.cdFlag" class="form-control"
                            ng-options="item.key as item.value for item in vm.cached.CARD_TYPE">
            ...
            <td class="col-xs-4">
                <%--<input type="text" ng-model="vm.item.ppFlag" class="form-control input-sm">--%>
                <select ng-model="vm.item.ppFlag" class="form-control"
            ...
            <tr>
                ...
                <td class="col-xs-4">
                    <%--<input type="text" ng-model="vm.item.sizeLimitFlag" class="form-control input-sm">--%>
                    <select ng-model="vm.item.sizeLimitFlag" class="form-control"
