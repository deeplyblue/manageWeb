...
<head>
    <title>Title</title>
    <script src="${ctx}/build/js/views/settlement/clear/redo/coerceMchntClearDetailApp-e58211e34b.js"></script>
</head>
<body ng-app="myApp" style="overflow:scroll;overflow-x:hidden">
<core:import url="../../../common/pageHead.jsp">
    <core:param name="title" value="商户强制结算"/>
</core:import>
<div ng-controller="queryCtrl" class="container-fluid">
    <form id="queryForm" name="queryForm" action="${ctx}/settlement/clear/redo/coerceMchntClearDetail/notarize"
