...
<head>
    <title>Title</title>
    <script src="${ctx}/build/js/views/settlement/clear/detail/mchntFeeClearDetailApp-ffe9d53cb3.js"></script>
</head>
<body ng-app="myApp" style="overflow:scroll;overflow-x:hidden">
<core:import url="../../../common/pageHead.jsp">
    <core:param name="title" value="商户手续费结算查询"/>
</core:import>
<div ng-controller="queryCtrl" class="container-fluid">
    <form id="queryForm" name="queryForm" action="${ctx}/settlement/clear/detail/mchntClearDetail/search" class="form-inline"
        ...
        <table class="table table-bordered table-condensed">
            ...
            <tr align="center">
                <td colspan="6">
                    ...
                    <shiro:hasPermission name="mchntFeeClearDetail_down">
                        <button down-file="${ctx}/settlement/clear/detail/mchntClearDetail/downloadFeeClear" params="vm.queryBean"
    ...
    <div>
        ...
        <table table-detail>
            ...
            <tr>
                ...
                <th rowspan="2">应收佣金（元）</th>
                <th rowspan="2">应退佣金（元）</th>
                <th rowspan="2">佣金净额（元）</th>
                <th rowspan="2">操作</th>
            </tr>
            <tr>
                <th>起始</th>
            ...
            <tr>
                ...
                <td>{{(bean.feeAmtR / 100-bean.feeAmtP / 100) | currency:''}}</td>
                <td>
            ...
            <tr>
                ...
                <td>{{(vm.sumObject.feeAmtR / 100-vm.sumObject.feeAmtP / 100) | currency:''}}</td>
            </tr>
            </tfoot>
        </table>
    </div>
