...
<head>
    <title>Title</title>
    <script src="${ctx}/build/js/views/settlement/clear/detail/payClearDetailApp-55437e6808.js"></script>
</head>
<body ng-app="myApp" style="overflow:scroll;overflow-x:hidden">
<core:import url="../../../common/pageHead.jsp">
    <core:param name="title" value="支付本金结算查询"/>
</core:import>
        ...
        <table class="table table-bordered table-condensed">
            ...
            <tr align="center">
                <td colspan="6">
                    ...
                    <shiro:hasPermission name="payClearDetail_down">
                        <button down-file="${ctx}/settlement/clear/detail/payClearDetail/download" params="vm.queryBean"
