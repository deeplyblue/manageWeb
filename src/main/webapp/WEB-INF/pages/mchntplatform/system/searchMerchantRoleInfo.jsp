...
<head>
    <title>Title</title>
    <script src="${ctx}/build/js/views/mchntplatform/system/merchantRoleApp-f3c5b45163.js"></script>
</head>
...
<div ng-controller="queryCtrl" class="container-fluid">
    <form id="queryForm" name="queryForm" action="${ctx}/mchntplatform/merchantRole/search" autocomplete="off">
    ...
    <div>
        <p class="btn-group">
<shiro:hasPermission name="merchantRole_add">
            <button ng-click="vm.addItem()"><i class="glyphicon glyphicon-plus"></i></button>
    </shiro:hasPermission>
<shiro:hasPermission name="merchantRole_update">
            <button ng-click="vm.updateItem()"><i class="glyphicon glyphicon-pencil"></i></button>
</shiro:hasPermission>
<shiro:hasPermission name="merchantRole_delete">
        ...
        <table table-detail>
            ...
            <tr>
                ...
                <td><shiro:hasPermission name="merchantRole_toAllocate">
                    <button ng-click="vm.resourceAllocate(bean.roleId)">权限分配</button>
