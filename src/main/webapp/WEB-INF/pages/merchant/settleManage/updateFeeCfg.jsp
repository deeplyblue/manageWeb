        ...
        <table class="table table-bordered">
            <tr>
                ...
                <td class="col-xs-4">
                    ...
                    <br/>{{vm.cached.MERCHANT_CODE[vm.item.companyCode]}}
                </td>
            </tr>
            <tr>
                <td class="text-right">
        ...
        <table class="table table-bordered" >
            ...
            <tr ng-repeat="temp in vm.item.feeSegRateModelList track by $index ">
                <td width="300px">
                    ...
                    <input ng-if="$index == 0" ng-model="vm.item.feeSegRateModelList[$index].segLowLmt" ng-init="vm.item.feeSegRateModelList[$index].segLowLmt='0'" type="text"  readonly="readonly" class="{{vm.constant.inputClass}}" >
                    ~
