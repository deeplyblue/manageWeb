...
<div common-modal-form>
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td class="col-xs-4">
                    <input type="text" name="merchantCode" ng-model="vm.item.merchantCode"
                           class="{{vm.constant.inputClass}} "
                           w5c-unique-check="{url:'${ctx}/merchant/info/checkCode?temp='+vm.item.merchantCode}"
                           required>
            ...
            <%--<tr>--%>
                ...
                <%--<select name="companyType" ng-model="vm.item.companyType" class="{{vm.constant.inputClass}} "--%>
                        <%--ng-options="key as value for (key,value) in {'<%=CompanyType.MERCHANT.getCode()%>':'<%=CompanyType.MERCHANT.getDesc()%>'}" required>--%>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="merchantAbbrName" ng-model="vm.item.merchantAbbrName" class="{{vm.constant.inputClass}} "
                           w5c-unique-check="{url:'${ctx}/merchant/info/checkAbbName?temp='+vm.item.merchantAbbrName}"
                           required  ng-pattern="/^[\s\S]{3,50}$/">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="merchantName" ng-model="vm.item.merchantName" class="{{vm.constant.inputClass}} "
                           w5c-unique-check="{url:'${ctx}/merchant/info/checkAbbName?temp='+vm.item.merchantName}"
                           required ng-pattern="/^[\s\S]{3,50}$/">
                </td>
            </tr>
            ...
            <%--<tr>--%>
                ...
                <%--</td>--%>
                <%--<td>--%>
                    <%--&lt;%&ndash;<input type="text" ng-model="vm.item.businessBeLong" class="{{vm.constant.inputClass}} "&ndash;%&gt;--%>
                           <%--&lt;%&ndash;typeahead-min-length="0"   uib-typeahead="item.key as item.value for item in vm.cached.BUSINESS_BELONG | filter:$viewValue | limitTo:6">&ndash;%&gt;--%>
                    <%--<select name="businessBeLong" ng-model="vm.item.businessBeLong" class="{{vm.constant.inputClass}} "--%>
                            <%--ng-options="item.key as item.value for item in vm.cached.BUSINESS_BELONG" required>--%>
                        <%--<option value="">请选择</option>--%>
                    <%--</select>--%>
                <%--</td>--%>
            <%--</tr>--%>
            ...
            <%--<tr>--%>
                ...
                <%--</td>--%>
                <%--<td>--%>
                    <%--<select ng-model="vm.item.suspendFlag" class="{{vm.constant.inputClass}} " name="suspendFlag" required>--%>
                        <%--<option value="">请选择</option>--%>
                        <%--<option value="0">否</option>--%>
                        <%--<option value="1">是</option>--%>
                    <%--</select>--%>
