...
<%--引入外部js--%>
    ...
    <script src="${ctx}/build/js/views/common/app-full-a30375aa20.min.js"></script>


    <script src="${ctx}/build/js/views/common/nav-jquery-d762925ca6.js"></script>
    <script src="${ctx}/build/js/views/common/nav-angular-4d3e9cf415.js"></script>
    <script src="${ctx}/build/js/views/common/directives-5bcfb2d290.js"></script>
