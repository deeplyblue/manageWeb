...
angular.module('myApp')
    ...
    .controller('queryCtrl',['$scope', '$http', '$httpParamSerializerJQLike', '$log', 'OpenService', 'CheckboxService',
        ...
        function queryErrDetail(payOrgCode, bankSettleDate) {
            $http.post(config.ctx + '/report/payBusiCheckReport/searchErrDetail',
                ...
                .then(function (response) {
                    ...
                    if (data.success) {
                        ...
                        OpenService({
                            modalTitle: '差异明细查询',
                            modalBody: config.ctx + '/report/payBusiCheckReport/toSearchErrDetail',
                            url: 'searchErrDetail',
...
angular.module('myApp').controller('QueryErrDetailModalInstanceCtrl', ['$scope', '$uibModalInstance', 'modalItem', '$http',
