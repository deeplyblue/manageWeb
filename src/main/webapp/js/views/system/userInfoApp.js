    ...
    .controller('queryCtrl', ['$scope', '$http', '$httpParamSerializerJQLike', '$log', 'OpenService', 'CheckboxService',
        'CacheService', 'limitToFilter', 'filterFilter', 'myConstant', 'growl', function ($scope, $http, $httpParamSerializerJQLike, $log, OpenService, CheckboxService,
            ...
            function queryDetail() {
                vm.url = config.ctx + '/system/user/search';
            ...
            function roleAllocate(user) {
                OpenService({
                    ...
                    cached: {
                        ROLE_INFO: CacheService.getCache('ROLE_INFO')
                    }
                }, function (item) {
                    vm.queryDetail();
            ...
            function resetPwd(user) {
                ...
                $http.post(config.ctx + '/system/user/resetPwd', {userId: user.userId}, config.jsonHeader)
                    .then(function (response) {
                        var data = response.data;
                        if (data.success) {
                            alert("操作成功");
...
angular.module('myApp').controller('ResetPwdModalInstanceCtrl', ['$scope', '$uibModalInstance', 'modalItem', '$http', 'myConstant'
