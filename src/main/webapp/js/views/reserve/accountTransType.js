    ...
    .controller('queryCtrl',['$scope', '$http', '$httpParamSerializerJQLike', '$log', 'OpenService', 'CheckboxService',
        ...
        function updateItem() {
            ...
            OpenService({
              ...
              $log.debug(item);
            },'updateAccountTypeController', "myModalContent.html");
        }
...
angular.module('myApp').controller('updateAccountTypeController', ['$scope', '$uibModalInstance', 'modalItem', '$http',
    '$httpParamSerializerJQLike', 'FileUploader', 'dateFilter', '$log', 'CheckboxService', 'myConstant', 'DateCalculateService', function ($scope, $uibModalInstance, modalItem, $http,
        ...
        $scope.save = function () {
            $http.post(config.ctx+'/reserve/trans/type/update', vm.item ,config.jsonHeader)
                .then(function (response) {
                    var data = response.data;
                    if (data.success) {
                        alert("操作成功");
