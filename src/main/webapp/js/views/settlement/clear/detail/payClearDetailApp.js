            ...
            $http.post(vm.url, $httpParamSerializerJQLike(vm.postData))
                .then(function (response) {
                    ...
                    if (data.success) {
                        ...
                        OpenService({
                            modalTitle: '支付本金结算查询-日结',
                            modalBody: 'redirectPayClearDay',
                            url: 'allocate',
                            item: {
                                results: results
                            },
...
angular.module('myApp').controller('PayClearDayModalInstanceCtrl',['$scope', '$uibModalInstance', 'modalItem', '$http',
