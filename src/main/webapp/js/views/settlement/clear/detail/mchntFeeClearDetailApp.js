            ...
            $http.post(vm.url, $httpParamSerializerJQLike(vm.postData))
                .then(function (response) {
                    ...
                    if (data.success) {
                        ...
                        OpenService({
                            modalTitle: '商户手续费结算查询-日结',
                            modalBody: 'redirectMchntFeeClearDay',
                            url: 'allocate',
                            item: {
                                results: results
                            },
                            ...
                            $log.debug(item);
                        }, 'MchntFeeClearDayModalInstanceCtrl');
                    } else {
                        alert(data.msg);
                    }
                });
...
angular.module('myApp').controller('MchntFeeClearDayModalInstanceCtrl',['$scope', '$uibModalInstance', 'modalItem', '$http',
