...
angular.module('myApp')
    ...
    .controller('queryCtrl',[ '$scope', '$http', '$httpParamSerializerJQLike', '$log', 'OpenService', 'CheckboxService',
        ...
        vm.redirectMchntClearDay = redirectMchntClearDay;
        ...
        function redirectMchntClearDay(bean) {
            $log.debug("bean.payOrgCode:", bean.payOrgCode);
            var results;
            vm.url = config.ctx + "/settlement/clear/detail/mchntClearDetail/getMchntClearDay";

            //组织参数
            vm.postData = {};
            vm.postData.payOrgCode = bean.payOrgCode;
            ...
            $http.post(vm.url, $httpParamSerializerJQLike(vm.postData))
                .then(function (response) {
                    ...
                    if (data.success) {
                        ...
                        OpenService({
                            modalTitle: '商户本金结算查询-日结',
                            modalBody: 'redirectMchntClearDay',
                            url: 'allocate',
                            item: {
                                results: results
                            },
                            ...
                            $log.debug(item);
                        }, 'MchntClearDayModalInstanceCtrl');
                    } else {
                        alert(data.msg);
                    }
                });
...
angular.module('myApp').controller('MchntClearDayModalInstanceCtrl',['$scope', '$uibModalInstance', 'modalItem', '$http',
    ...
    vm.redirectMchntSettleDetail = redirectMchntSettleDetail;
    vm.queryDetail = queryDetail;

    function redirectMchntSettleDetail(bean, bool) {
        ...
        //显示隐藏div
        vm.detailFlag = true;
        vm.url = config.ctx + "/settlement/clear/detail/mchntClearDetail/redirectMchntSettleDetail";
        //组织参数
        vm.postData = {};
        vm.postData.orgCode = bean.orgCode;
    ...
    function queryDetail() {
        redirectMchntSettleDetail(vm.queryBean, false);
    }
}]);
