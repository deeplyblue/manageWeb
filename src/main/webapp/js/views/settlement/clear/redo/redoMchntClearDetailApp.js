...
angular.module('myApp')
    ...
    .controller('queryCtrl', ['$scope', '$http', '$httpParamSerializerJQLike', '$log', 'OpenService','CheckboxService',
        ...
        //操作条件
        vm.queryBean = {};
        vm.queryBean.settleDate = DateCalculateService.getYesterday();
        ...
        function queryDetail() {
            ...
            vm.postData.settleDate = dateFilter(vm.postData.settleDate, 'yyyyMMdd');
            if(vm.postData.companyCode == null || vm.postData.companyCode == ''){
                alert("商户不能为空！");
                return;
            }
