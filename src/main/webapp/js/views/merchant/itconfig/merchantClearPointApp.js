...
angular.module('myApp')
    ...
    .controller('queryCtrl',['$scope', '$http', '$httpParamSerializerJQLike', '$log', 'OpenService', 'CheckboxService',
        ...
        function deleteItem() {
            ...
            $http.post(config.ctx+'/merchant/itCfg/point/delete', $httpParamSerializerJQLike({'id': CheckboxService.getCheckedNew(vm.pagination.list)[0].id}))
                .then(function (response) {
                    var data = response.data;
                    if (data.success) {
