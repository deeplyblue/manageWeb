...
angular.module('myApp')
    ...
    .controller('queryCtrl',['$scope', '$http', '$httpParamSerializerJQLike', '$log', 'OpenService', 'CheckboxService','CacheService','dateFilter','myConstant',
        ...
        function updateItemEnableFlag(item, status) {
            ...
            $http.post(config.ctx + '/merchant/merchantContaract/updateItemEnableFlag', postData, config.jsonHeader)
                .then(function (response) {
                    var data = response.data;
                    if (data.success) {
...
angular.module('myApp').controller('updateContractModalInstanceCtrl',['$scope', '$uibModalInstance', 'modalItem', '$http',
    'FileUploader', '$httpParamSerializerJQLike','$log','dateFilter','myConstant', function ($scope, $uibModalInstance, modalItem, $http,
                                                                                FileUploader, $httpParamSerializerJQLike, $log, dateFilter, myConstant) {
